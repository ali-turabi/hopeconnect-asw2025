...
exports.validateAssignment = [
    ...
    check('volunteerId').isInt().withMessage('Volunteer ID must be an integer'),
     check('completion_status').isIn(['pending', 'in_progress', 'completed'])
        .withMessage('Invalid completionstatus')
];
...
exports.validateExpenditure = [
    ...
    check('category').isIn(['food', 'education', 'healthcare', 'clothing', 'shelter']).withMessage('Invalid category'),
    check('description').notEmpty().withMessage('Description is required'),
