...
router.post('/', authenticate, authorize('user', 'admin'), validateVolunteerRegistration, volunteerController.registerVolunteer);
...
router.get('/:id', authenticate, authorize('volunteer', 'admin'), volunteerController.getVolunteerProfile);
