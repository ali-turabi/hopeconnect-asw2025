const {
  ...
  getAllMappingDonations,
  updateLogisticsStatus,
  deleteLogisticsRequest,
  deleteDonationById,
  getLogisticsTrackingInfo
} = require('../models/logisticsModels');
...
const removeDonationById = async (req, res) => {
  const { id } = req.params;
...
const createMappingDonation = async (req, res) => {
...
const fetchAllMappingDonations = async (req, res) => {
  try {
...
const updateMappingDonation = async (req, res) => {
...
const removeMappingDonation = async (req, res) => {
  const { id } = req.params;
